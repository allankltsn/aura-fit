...
export const color = {
  ...
  redScale: ['#fdeced', '#fad3d5', '#f2a3a8', '#e6656d', '#d13a44', '#b1111b', '#960f17', '#7b0c13', '#5e090f', '#43060a'],
  grayScale: ['#f5f5f5', '#ececec', '#e3e3e3', '#cfcfcf', '#b0b0b0', '#8d8d8d', '#666666', '#444444', '#2b2b2b', '#1f1f1f'],
  gray: '#b0b0b0',
  dark: '#1f1f1f',
  light: '#f5f5f5',
